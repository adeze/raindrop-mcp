...
async function handleCollectionManage(
  ...
  switch (args.operation) {
    ...
    case "update":
      ...
      return await raindropService.updateCollection(
        args.id,
...
async function handleBookmarkManage(
  ...
  switch (args.operation) {
    case "create":
      ...
      return await raindropService.createBookmark(
        args.collectionId,
    ...
    case "update":
      ...
      return await raindropService.updateBookmark(
        args.id,
        updatePayload as any,
      );
    case "delete":
...
async function handleTagManage(
  ...
  switch (args.operation) {
    case "rename":
      ...
      return await raindropService.renameTag(
        args.collectionId,
        primaryTag,
        args.newName!,
      );
    case "merge":
      ...
      return await raindropService.mergeTags(
        args.collectionId,
        args.tagNames,
        args.newName!,
      );
...
async function handleHighlightManage(
  ...
  switch (args.operation) {
    case "create":
      ...
      return await raindropService.createHighlight(
        args.bookmarkId,
        createPayload as any,
      );
    case "update":
      ...
      setIfDefined(updatePayload, "color", args.color);
      return await raindropService.updateHighlight(
        args.id,
        updatePayload as any,
      );
    case "delete":
...
async function handleGetRaindrop(
...
async function handleListRaindrops(
...
async function handleBulkEditRaindrops(
...
const diagnosticsTool = defineTool({
  name: "diagnostics",
  description:
    "Provides server diagnostics and environment info. Use includeEnvironment param for detailed info.",
